...
public class StationAdapter extends WyCommonAdapter<XmlUtils.BikeStation> {


    public StationAdapter(Context context, List<XmlUtils.BikeStation> data, int layoutId) {
        super(context, data, layoutId);
    }

    @Override
    public void convert(WyViewHolder holder, XmlUtils.BikeStation bikeStation) {
